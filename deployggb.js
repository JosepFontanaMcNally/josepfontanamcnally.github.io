...
(function() {
    ...
    var GGBApplet = function() {
        ...
        var setDefaultHTML5CodebaseForVersion = function(version, offline) {
            ...
            if (index > 0) {
                ...
                codebase = "https://www.geogebra.org/apps/5.0.659.0/"
            }
    ...
    GGBAppletUtils.makeModule = function(name, permutation) {
        function webModule() {
            ...
            B();
            webModule.__moduleBase = "https://www.geogebra.org/apps/5.0.659.0/" + name + "/";
    ...
    if (typeof window.web3d !== "function") {
        window.web3d = GGBAppletUtils.makeModule("web3d", "96C2B9D4B0BD732D533F35514F21A1C2")
    }
    if (typeof window.webSimple !== "function") {
        window.webSimple = GGBAppletUtils.makeModule("webSimple", "4960DA5D3CE37B10CA0D7D1E3BE57034")
    }
